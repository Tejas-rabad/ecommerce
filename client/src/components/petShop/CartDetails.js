...
const CartDetails = () => {
    ...
    const total = ()=>{
        let totalprice = 0
        carts.map((ele,ind)=>{
            totalprice = ele.lprices * ele.qnty + totalprice
        });
        setPrice(totalprice)
    }  
    ...
    useEffect(()=>{
     ...
     const makePayment = async()=>{
        const stripe = await loadStripe("pk_test_51P6rPUSJNqLbSY7ciW82hAvKGWTlCbj1YKJEzYUaNagxqVaQWpM4PrlR6eJD1PNtBTevJSiYjNBU7uTLaMotCKEV00rYCFUrF6");
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td><div className='product-name'><p>{data.item}</p></div></td>
                                                                <td>{data.lprices}</td>
                                                                <td>
                                                                ...
                                                                <td className='text-right'>₹ {data.qnty * data.lprices}</td>
                                                            </tr>
                                                        </>
                                                    )
                                                })
